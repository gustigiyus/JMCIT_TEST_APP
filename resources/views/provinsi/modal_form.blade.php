        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                <div class="">
                    ...
                    <label for="nama_provinsi" class="nama_provinsi_label block mb-2 text-md font-bold">Nama
                        Provinsi
                    </label>
                    <input type="text" name="nama_provinsi" id="nama_provinsi" placeholder="Masukan Nama Provinsi"
                        class="nama_provinsi dark:bg-gray-700 block w-full p-2.5 text-sm rounded-lg"
                        placeholder="Error input">
                    <p class="mt-2 text-sm font-medium nama_provinsi_msg"></p>
                </div>
            </div>
